...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <!-- Sidebar Menu -->
      <?php $page = "message.php"; include_once 'View/navigation.php'?>
      <!-- /.sidebar-menu -->
    </div>
    <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
     <div class="card">
     <div class="alert alert-primary">Contact Message</div>
     <div class="card-body">
     ...
     $users=new Message();
     if(isset($_SESSION['mes_id'])){

        $id=$_SESSION['mes_id'];
        $users->DelMessage($id);
     }
     $user_data=$users->GetMessage($start,$limit);
     ...
     <td><?php echo $u->message_date;?></td>
     <td><a class="btn btn-primary" href="../Controller/mesdelete.php?mes_id=<?php echo $u->message_id;?>">Delete</a></td>
     </tr>
     <?php } ?>
     </tbody>
     </table>
