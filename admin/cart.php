...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <!-- Sidebar Menu -->
      <?php $page = "cart.php"; include_once 'View/navigation.php'?>
      <!-- /.sidebar-menu -->
    </div>
    <!-- /.sidebar -->
  </aside>
...
<?php
    ...
    $db_obj=Db_Connection::db_connect();
        ...
        $selectcust="SELECT * FROM `users` join `order` ON(users.user_id=order.user_id) join `products` ON(order.product_id=products.product_id) WHERE users.user_id='$id'";
    ...
    <div class="container">
     <div class="card">
     <div class="alert alert-primary"><?php echo $fullname?> Cart  <a href="customer.php" class="btn btn-success"> Customer</a></div>
     <div class="card-body">
