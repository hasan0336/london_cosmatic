  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- Main row -->
        <div class="card">
            <div class="alert alert-primary">Added Product</div>
            <div class="card-body">
            <div class="row">
            <div class="col-md-12">
    ...
    <?php 
     $db_obj=Db_Connection::db_connect();
                          $showproduct="SELECT * FROM `products` ORDER BY `products`.`product_id` DESC";
    ...
    $obj= new Product();
     $cat=$obj->GetProduct($start,$limit);
     ...
     ?>
      <tr>
        <td><?php echo $c->proid;?></td>
        <td><img src="../Product/<?php echo $c->product_name;?>/<?php echo $c->product_image;?>" style="width:50px;"  class="img-fluid"></td>
        <td><?php echo $c->product_name;?></td>
        <td><?php echo $c->product_desction;?></td>
        <td><?php echo $c->product_price;?></td>
        <td>
        <a href="../Controller/deleteproductcontroller.php?productid=<?php echo $c->proid;?>" class="btn btn-danger">Delete</a>
        <a href="../Controller/editproductcontroller.php?productid=<?php echo $c->proid;?>" class="btn btn-success">Edit</a>
