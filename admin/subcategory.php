            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="alert alert-primary">Sub Category Add</div>
                            <div class="card-body">
                                <div class="row">
                                    <div class=" col-md-4">
                                        <form action="../Controller/addsubcategorycontroller.php" method="post" enctype="multipart/form-data" id="subcatform">
                                          <div class="form-group">
                                            <label for="category">Category:</label>
                                              <select name="category" id="category" class="form-control" required="">
                                                <option value="">Select Category</option>
                                                <?php $cat_obj=new Product();
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <?php echo $c->subcategory;?>
                                                        </td>
                                                        <td>
                                                            <a href="../Controller/deletesubcategorycontroller.php?commonid=<?php echo $c->sub_cat_id;?>" class="btn btn-danger">Delete</a>
