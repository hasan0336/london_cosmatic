...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <!-- Sidebar Menu -->
	  <?php $page = "addstyle.php"; include_once 'View/navigation.php'?>
      <!-- /.sidebar-menu -->
    </div>
    <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- Main row -->
		<div class="card">
            <div class="alert alert-primary">Style Add</div>
            <div class="card-body">
            <div class="row">
            <div class=" col-md-6">
            <form action="../Controller/addstylecontroller.php" method="post" enctype="multipart/form-data">

  <div class="form-group">
    <label for="pwd">Add Style:</label>
  ...
  <input type="submit" class="btn btn-default" value="Add style">
    ...
    $obj= new Product();
     ...
     ?>
      <tr>
        <td><?php echo $c->product_style;?></td>
        <td>
        <a href="../Controller/deletestylecontroller.php?commonid=<?php echo $c->style_id;?>" class="btn btn-danger">Delete</a>
