...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <!-- Sidebar Menu -->
      <?php $page = "index1.php"; include_once 'View/navigation.php'?>
      <!-- /.sidebar-menu -->
    </div>
    <!-- /.sidebar -->
  </aside>
        ...
        <div class="row">
              ...
              <div class="inner">
                <h3>
                    <?php 
                        ...
                        $totaluser="SELECT * FROM `order`";
                        $result=$db_obj->query($totaluser);
              ...
              <div class="inner">
                <h3>
                     <?php 
                        ...
                        $totaluser="SELECT * FROM `messages`";
                        $result=$db_obj->query($totaluser);
                        $total=mysqli_num_rows($result);
                        echo $total;
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3>
                    <?php 
                        ...
                        $totaluser="SELECT * FROM `products`";
                        $result=$db_obj->query($totaluser);
                        $total=mysqli_num_rows($result);
                        echo $total;
              ...
              <a href="showproduct.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
