...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <!-- Sidebar Menu -->
	  <?php $page = "addbrand.php"; include_once 'View/navigation.php'?>
      <!-- /.sidebar-menu -->
    </div>
    <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
		...
		<div class="card">
            <div class="alert alert-primary">Brand Add</div>
            <div class="card-body">
            <div class="row">
            <div class=" col-md-6">
            <form action="../Controller/addbrandcontroller.php" method="post" enctype="multipart/form-data">

  <div class="form-group">
    <label for="pwd">Add Brand:</label>
  ...
  <input type="submit" class="btn btn-default" value="Add brand">
    ...
    $obj= new Product();
     ...
     ?>
      <tr>
        <td><?php echo $c->product_brand;?></td>
        <td>
        <a href="../Controller/deletebrandcontroller.php?commonid=<?php echo $c->brand_id;?>" class="btn btn-danger">Delete</a>
