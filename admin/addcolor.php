...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <!-- Sidebar Menu -->
      <?php $page = "addcolor.php"; include_once 'View/navigation.php'?>
      <!-- /.sidebar-menu -->
    </div>
    <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
		...
		<div class="card">
            <div class="alert alert-primary">Color Add</div>
            <div class="card-body">
            <div class="row">
            <div class=" col-md-6">
            <form action="../Controller/addcolorcontroller.php" method="post" enctype="multipart/form-data">

  <div class="form-group">
    <label for="pwd">Add Color:</label>
    <input type="text" name="color" class="form-control" id="color">
  </div>
  
  
  <input type="submit" class="btn btn-default" value="Add Color">
</form>
            </div>
            <div class="col-md-6">
			<label>Color</label>
    ...
    $obj= new Product();
     ...
     ?>
      <tr>
        ...
        <td>
        <a href="../Controller/deletecolorcontroller.php?commonid=<?php echo $c->color_id;?>" class="btn btn-danger">Delete</a>
